...
class SurveyQuestion4 : AppCompatActivity() {
    ...
    fun init(){
        TV_question = findViewById<TextView>(R.id.textViewGetQuestion4)
        radioGroupAnswer = findViewById<RadioGroup>(R.id.radioGroupAnswers4)
        buttonNext = findViewById<Button>(R.id.btnPrevQuestion4)
        ...
        if(getIntent().getExtras() != null){
            ...
            TV_question.text = survey.question4;
        }
        ...
        buttonNext.setOnClickListener{
            ...
            if(selected != -1){
                ...
                val intent = Intent(this@SurveyQuestion4, SurveyQuestion5::class.java)
                ...
                databaseHelper.addAnswer(
                    SurveyResponse(-1, getIntent().getSerializableExtra("StudentId") as Int,
                        ...
                        (getIntent().getSerializableExtra("Survey") as Survey).surID, answer.text.toString(), 4)
                )
                ...
                Toast.makeText(this@SurveyQuestion4, "Select option", Toast.LENGTH_SHORT).show()
            }
