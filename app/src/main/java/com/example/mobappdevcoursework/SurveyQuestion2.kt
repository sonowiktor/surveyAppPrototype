...
class SurveyQuestion2 : AppCompatActivity() {
    ...
    fun init(){
        TV_question = findViewById<TextView>(R.id.textViewGetQuestion2)
        radioGroupAnswer = findViewById<RadioGroup>(R.id.radioGroupAnswer2)
        buttonNext = findViewById<Button>(R.id.btnNextQuestion2)
        ...
        if(getIntent().getExtras() != null){
            ...
            TV_question.text = survey.question2;
        }
        ...
        buttonNext.setOnClickListener{
            ...
            if(selected != -1){
                ...
                val intent = Intent(this@SurveyQuestion2, SurveyQuestion3::class.java)
                ...
                Toast.makeText(this@SurveyQuestion2, "Select option", Toast.LENGTH_SHORT).show()
            }
